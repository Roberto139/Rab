...
typedef struct st_listaE
{
    int e;
    struct st_listaE *prox;
}listaE_t;

typedef struct st_listaD
{
    int ei;
    char lei;
    int ef;
    struct st_listaD *prox;
}listaD_t;
...
typedef struct st_llista
{
    struct st_listaE *est;
    struct st_llista *prox;
}llista_t;
